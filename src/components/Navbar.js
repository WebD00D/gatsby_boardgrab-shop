			...
			<div className="navbar">
				<div className="navbar__logo-wrap">
					...
					<div className="navbar__location-selector" onClick={this.handleLocationDropDown}>
						...
						<div className={cx(['navbar__location__dropdown'], {
								'd-none': !this.state.locationSelectorOpen
							})}>
							<div className="navbar__location__dropdown__header">Boardgrab Locations</div>
							<div onClick={() => this.handleRegionChange('All Locations')} className="navbar__location__dropdown__item">
								All locations
							</div>
							<div onClick={() => this.handleRegionChange('Southern California')} className="navbar__location__dropdown__item">
								Southern California
							</div>
							<div onClick={() => this.handleRegionChange('Northern California')} className="navbar__location__dropdown__item">
								Northern California
							</div>
							<div onClick={() => this.handleRegionChange('Pacific North West')} className="navbar__location__dropdown__item">
								Pacific North West
							</div>
							<div onClick={() => this.handleRegionChange('Mid Atlantic')} className="navbar__location__dropdown__item">
								Mid-Atlantic
							</div>
							<div onClick={() => this.handleRegionChange('South East')} className="navbar__location__dropdown__item">
								South East
							</div>
					...
					<div className={cx([
						...
						])} style={{ marginLeft: '30px' }} onClick={this.handleSubLocationDropDown}>
